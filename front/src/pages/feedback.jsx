  ...
  return (
    <div className="min-h-screen bg-green-500 p-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-4xl font-bold text-center mb-8 py-4 bg-green-500">FEEDBACK DE BENEFICIOS</h1>
          ...
          <div className="col-span-2">
            {beneficiosFiltrados.length > 0 ? (
              ...
              <div className="bg-white rounded-2xl p-8 text-center">
                <p className="text-lg">No se encontraron beneficios con los filtros seleccionados.</p>
              </div>
            )}
          </div>
