    ...
    <div>
      ...
      >
        ...
        <nav className="flex flex-col space-y-4 mt-4">
          ...
          <Link
            to="/inspeccion/oferta"
            className={`p-3! rounded-xl! flex! items-center! gap-3! transition-all! duration-300! ${
              location.pathname === "/inspeccion/oferta"
                ? "bg-white! text-green-600! shadow-lg!"
                : "text-white! hover:bg-white/20!"
            }`}
            style={{ border: 'none' }}
          ...
          <Link
            to="/inspeccion/reporte" 
            className={`p-3! rounded-xl! flex! items-center! gap-3! transition-all! duration-300! ${
              location.pathname === "/inspeccion/reporte"
                ? "bg-white! text-green-600! shadow-lg!"
                : "text-white! hover:bg-white/20!"
            }`}
            style={{ border: 'none' }}
          ...
          <Link
            to="/inspeccion/bloqueo"
            className={`p-3! rounded-xl! flex! items-center! gap-3! transition-all! duration-300! ${
              location.pathname === "/inspeccion/bloqueo"
                ? "bg-white! text-green-600! shadow-lg!"
                : "text-white! hover:bg-white/20!"
            }`}
            style={{ border: 'none' }}
