...
const FiltrosModeracion = ({ filtros, onFiltrosChange, onLimpiarFiltros }) => {
  ...
  const hayFiltrosActivos = filtros.search || filtros.estado || filtros.carrera;
    ...
    <div className="bg-white! rounded-2xl! p-6! mb-8! shadow-md! border-2! border-gray-100!">
      <div className="grid! grid-cols-1! md:grid-cols-2! lg:grid-cols-3! gap-4!">
        ...
        <div>
          ...
          >
            <option value="" className="text-gray-500!">Todas las carreras</option>
            {CARRERAS.map((carrera) => (
              <option key={carrera} value={carrera} className="text-gray-800!">
                {carrera}
              </option>
            ))}
          </select>
