...
export default function CardOfertaLaboral(props) {
  ...
  const { id, cargo, empresa, area, ubicacion, tipoContrato, salario, estado } =
    props;
  ...
  return (
    <div className="bg-white w-[100%] hover:cursor-pointer text-[#1e1e1e] flex flex-row justify-between m-auto mt-4 px-14 py-8 rounded-3xl shadow-md">
