        ...
        <nav className="flex flex-col space-y-4 mt-4">
          ...
          {user && (
            <>
              ...
              <Link
                to="/foro-egresados"
                className={`p-3 rounded-lg flex items-center gap-3 text-gray-200 ${location.pathname === "/foro-egresados"
                  ? "bg-teal-600/80 text-white shadow-lg"
                  : "hover:bg-teal-500/20 hover:text-teal-300 transition"
                  }`}
              >
              ...
              <Link
                to="/noticias"
                className={`p-3 rounded-lg flex items-center gap-3 text-gray-200 ${location.pathname.startsWith("/noticias")
                  ? "bg-teal-600/80 text-white shadow-lg"
                  : "hover:bg-teal-500/20 hover:text-teal-300 transition"
                  }`}
              >
